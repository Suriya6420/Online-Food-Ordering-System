...
<br>			
<div id="divitemlist"><?php include("ajaxdailyorderitemlist.php"); ?></div>
...
{
	$.post("ajaxdailyorderitemlist.php", {foodtype: foodtype,restaurantid: restaurantid}, function(result){
		//alert(result);
